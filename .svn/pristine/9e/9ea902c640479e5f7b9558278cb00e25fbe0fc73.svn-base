...
@Listeners({ MethodInterceptor.class, TestListeners.class,
...
public class TestHboSignUp extends TestBase {
	...
	public static void testSignupFail(String operator) throws Exception {
		...
		verifyTrue(isTextPresent("<p>Az e-mail címek nem egyeznek<br></p>"),
				"Verify: the Valid Email error message displayed.<br>");

		ElementScreenshot.captureElementScreenshot(driver.findElement(By
				.xpath(".//*[@id='operatorTypeNormal']/div[2]")));
