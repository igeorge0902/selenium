...
public class CaptureScreenshotOnFailureListener extends TestListenerAdapter implements WebElements
{
	...
	public static void captureScreenShot() {
           ...
           || (driver instanceof EventFiringWebDriver))
        {
            ...
            String playBack = driver.findElement(By.id(playbackTitle)).getText();
            ...
            System.out.println(" *** Capture files are created in " + userHome + File.separator + "Documents" + File.separator + "Tests" + File.separator);
            Log.info(" *** Capture files are created in " + userHome + File.separator + "Documents" + File.separator + "Tests" + File.separator);
