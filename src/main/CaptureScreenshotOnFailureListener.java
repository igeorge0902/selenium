...
public class CaptureScreenshotOnFailureListener extends TestListenerAdapter
	...
	public static void captureScreenShot() {
		...
		if ((driver instanceof InternetExplorerDriver)
	        ...
	        String screenShotsFolder = workingDir + File.separator + "test-output" + File.separatorChar + "html" + File.separator +"ScreenShots" + File.separator;
			...
			System.out.println(" *** Capture files are created in " + screenShotsFolder	+ File.separator);
			Log.info(" *** Capture files are created in " + screenShotsFolder	+ File.separator);
	...
	public void onTestFailure(ITestResult testResult) {
		...
		if ((driver instanceof InternetExplorerDriver)
			...
			String absolute = file.getAbsolutePath();
			//int beginIndex = absolute.indexOf(".");
			//String relative = absolute.substring(beginIndex).replace(".\\", File.separator);
			//String screenShot = relative.replace('\\', '/');
			...
			Reporter.log("<a href=\"" + pathRelative + "\"><p align=\"left\">Error screenshot at " + new Date() + "</p>");
