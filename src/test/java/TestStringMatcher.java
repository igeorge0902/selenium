...
public class TestStringMatcher {
  ...
  @Test
  public void isPlayerHbo() {
    assertTrue(m.isPlayerHbo("http://player.mediaux.biz/content/angelique-976043498"));
    assertTrue(m.isPlayButton("play-button-07572899-1f5a-4f4e-9204-2fcc63a82775"));
    
  }
  
  @Test
  public void regexTest() {
	  assertFalse(m.regexTest(false));
  }
